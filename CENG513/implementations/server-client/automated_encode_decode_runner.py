...
time.sleep(WAIT_DELAY)
corto_encode_process = subprocess.Popen(['python3' , "./Encode-Decodes/corto_encoder_decoder.py" , name_of_ply_file ,  str(int(CORTO_ENCODER_LOGGER_TIMER * 1e3)) ] ).wait()
time.sleep(WAIT_DELAY )
...
server_process = subprocess.Popen(['python3' , "server.py" , name_of_ply_file ,  str(int(SENDING_NUMBER_OF_TIMES)) , str(PORT)  , sending_options , str(number_of_ports) ]  )
time.sleep(10 )
client_process = subprocess.Popen([ 'python3' , "client.py" ,str(PORT)  , sending_options , str(number_of_ports)]   ).wait()
time_before_encoding = datetime.datetime.now()
f.write( str(time_before_encoding.hour) + ":" +  str(time_before_encoding.minute)+ ":" + str(time_before_encoding.second) + "." + str(str(time_before_encoding.microsecond)[:2]+"0") + "\n" )
f.close()
...
time_before_encoding = datetime.datetime.now()
f.write( str(time_before_encoding.hour) + ":" +  str(time_before_encoding.minute)+ ":" + str(time_before_encoding.second) + "." + str(str(time_before_encoding.microsecond)[:2]+"0") + "\n" )
server_process2 = subprocess.Popen(['python3' , "server.py" , name_of_ply_file + ".drc" ,  str(int(SENDING_NUMBER_OF_TIMES)) , str(int( PORT) + int(number_of_ports) + 1 ) ,  sending_options , str(number_of_ports) ]  )
time.sleep(10 )
client_process2 = subprocess.Popen([ 'python3' , "client.py" , str(int( PORT) + int(number_of_ports) + 1 ) ,  sending_options , str(number_of_ports) ]  ).wait()
time_before_encoding = datetime.datetime.now()
f.write(  str(time_before_encoding.hour) + ":" +  str(time_before_encoding.minute)+ ":" + str(time_before_encoding.second) + "." + str(str(time_before_encoding.microsecond)[:2]+"0") + "\n" )
f.close()
...
time_before_encoding = datetime.datetime.now()
f.write( str(time_before_encoding.hour) + ":" +  str(time_before_encoding.minute)+ ":" + str(time_before_encoding.second) + "." + str(str(time_before_encoding.microsecond)[:2]+"0") + "\n" )
server_process3 = subprocess.Popen(['python3' , "server.py" , name_of_ply_file[ : len(name_of_ply_file) -4 ] + ".crt" ,  str(int(SENDING_NUMBER_OF_TIMES)) ,  str( int( PORT) + int(number_of_ports) + 2  ) ,  sending_options , str(number_of_ports) ]  )
time.sleep(10 )
client_process3 = subprocess.Popen([ 'python3' , "client.py" , str(PORT + 2 ), str( int( PORT) + int(number_of_ports) + 2  ) ,  sending_options , str(number_of_ports) ]  ).wait()
time_before_encoding = datetime.datetime.now()
f.write( str(time_before_encoding.hour) + ":" +  str(time_before_encoding.minute)+ ":" + str(time_before_encoding.second) + "." + str(str(time_before_encoding.microsecond)[:2]+"0") + "\n" )
f.close()
